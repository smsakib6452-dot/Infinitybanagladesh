...
const supabaseUrl =
  import.meta.env.VITE_SUPABASE_URL || 'https://pzpnphgnexfaxxaorqsq.supabase.co';
const supabaseAnonKey =
  import.meta.env.VITE_SUPABASE_ANON_KEY || 'sb_publishable_Vqapvc2C91UpllwvFevK9w_OJPdTi3V';
